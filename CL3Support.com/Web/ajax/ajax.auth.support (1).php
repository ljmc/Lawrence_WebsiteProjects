<?php
	...
	$mResponse["isValid"] = $systemExecution->runQuery("SELECT COUNT(id) AS supporterCount FROM web_supporter WHERE auth_code = '%s'", $mAuthCode)->fetch_object()->supporterCount == 1 ? true : "Invalid authentification code";
